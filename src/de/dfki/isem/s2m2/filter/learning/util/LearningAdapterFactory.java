...
public class LearningAdapterFactory extends AdapterFactoryImpl {
	...
	protected LearningSwitch<Adapter> modelSwitch =
		new LearningSwitch<Adapter>() {
			...
			@Override
			public <Domain> Adapter caseTrainingSet(TrainingSet<Domain> object) {
				return createTrainingSetAdapter();
			}
			@Override
			public <Domain> Adapter caseSample(Sample<Domain> object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.isem.s2m2.filter.learning.TrainingSet <em>Training Set</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.isem.s2m2.filter.learning.Sample <em>Sample</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
