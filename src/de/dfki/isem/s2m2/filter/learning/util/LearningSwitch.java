...
public class LearningSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LearningPackage.AGGREGATION_LEARNER: {
				AggregationLearner<?> aggregationLearner = (AggregationLearner<?>)theEObject;
				T result = caseAggregationLearner(aggregationLearner);
				if (result == null) result = caseExpression(aggregationLearner);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LearningPackage.TRAINING_SET: {
				TrainingSet<?> trainingSet = (TrainingSet<?>)theEObject;
				T result = caseTrainingSet(trainingSet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LearningPackage.SAMPLE: {
	 ...
	 * @generated
	 */
	public <Domain> T caseTrainingSet(TrainingSet<Domain> object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public <Domain> T caseSample(Sample<Domain> object) {
		return null;
	}
