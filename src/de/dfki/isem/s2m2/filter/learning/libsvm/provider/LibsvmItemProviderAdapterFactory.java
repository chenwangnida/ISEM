...
import de.dfki.isem.s2m2.filter.learning.libsvm.util.LibsvmAdapterFactory;
 ...
 * @generated
 */
public class LibsvmItemProviderAdapterFactory extends LibsvmAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	/**
	 ...
	 * @generated
	 */
	public LibsvmItemProviderAdapterFactory() {
	...
	/**
	 * This keeps track of the one adapter used for all {@link de.dfki.isem.s2m2.filter.learning.libsvm.LibSVMAggregation} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected LibSVMAggregationItemProvider libSVMAggregationItemProvider;

	/**
	 * This creates an adapter for a {@link de.dfki.isem.s2m2.filter.learning.libsvm.LibSVMAggregation}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createLibSVMAggregationAdapter() {
		if (libSVMAggregationItemProvider == null) {
			libSVMAggregationItemProvider = new LibSVMAggregationItemProvider(this);
		}

		return libSVMAggregationItemProvider;
	}
	 ...
	 */
	public void dispose() {
		if (libSVMAggregationItemProvider != null) libSVMAggregationItemProvider.dispose();
	}
