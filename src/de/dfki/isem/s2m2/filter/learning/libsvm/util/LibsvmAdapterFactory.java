 ...
 * @generated
 */
public class LibsvmAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected LibsvmSwitch<Adapter> modelSwitch =
		new LibsvmSwitch<Adapter>() {
			@Override
			public Adapter caseLibSVMAggregation(LibSVMAggregation object) {
				return createLibSVMAggregationAdapter();
			}
			@Override
			...
			@Override
			public <Domain> Adapter caseAggregationLearner(AggregationLearner<Domain> object) {
				return createAggregationLearnerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.isem.s2m2.filter.learning.libsvm.LibSVMAggregation <em>Lib SVM Aggregation</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createLibSVMAggregationAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.isem.s2m2.filter.learning.AggregationLearner <em>Aggregation Learner</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAggregationLearnerAdapter() {
		return null;
	}
