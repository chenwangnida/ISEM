 ...
 * $Id$
 */
package de.dfki.s2m2.filter.inference.util;
 ...
 * @generated
 */
public class InferenceSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case InferencePackage.INFERENCE_ENGINE: {
				InferenceEngine<?> inferenceEngine = (InferenceEngine<?>)theEObject;
				T result = caseInferenceEngine(inferenceEngine);
				if (result == null) result = caseResource(inferenceEngine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InferencePackage.INFERENCE_CAPABILITY: {
				InferenceCapability<?, ?> inferenceCapability = (InferenceCapability<?, ?>)theEObject;
				T result = caseInferenceCapability(inferenceCapability);
				if (result == null) result = caseExpression(inferenceCapability);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
