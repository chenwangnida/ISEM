 ...
 * $Id$
 */
package de.dfki.s2m2.filter.inference.dl.pellet.util;
...
public class PelletSwitch<T> {
	 ...
	 * @generated
	 */
	protected static PelletPackage modelPackage;
	...
	public PelletSwitch() {
		if (modelPackage == null) {
			modelPackage = PelletPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PelletPackage.PELLET_REASONER: {
				PelletReasoner pelletReasoner = (PelletReasoner)theEObject;
				T result = casePelletReasoner(pelletReasoner);
				if (result == null) result = caseDLReasoner(pelletReasoner);
				if (result == null) result = caseInferenceEngine(pelletReasoner);
				if (result == null) result = caseResource(pelletReasoner);
