 ...
 * <ul>
 *   <li>{@link de.dfki.s2m2.filter.impl.AverageImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.dfki.s2m2.filter.impl.AverageImpl#getOperands <em>Operands</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AverageImpl<Domain> extends EObjectImpl implements Average<Domain> {
	/**
	...
	protected EClass eStaticClass() {
		return FilterPackage.Literals.AVERAGE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FilterPackage.AVERAGE__NAME, oldName, name));
	}
	...
	public EList<Expression<Domain, Double>> getOperands() {
		if (operands == null) {
			operands = new EObjectContainmentEList<Expression<Domain, Double>>(Expression.class, this, FilterPackage.AVERAGE__OPERANDS);
		}
		return operands;
	}
	...
	public Double evaluate(Domain param1, Domain param2) throws ExpressionEvaluationException {
		...
		for(Expression<Domain, Double> exp : operands) {
			sum += exp.evaluate(param1, param2);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FilterPackage.AVERAGE__OPERANDS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FilterPackage.AVERAGE__NAME:
				return getName();
			case FilterPackage.AVERAGE__OPERANDS:
				return getOperands();
		}
