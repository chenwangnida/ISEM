 ...
 * <ul>
 *   <li>{@link de.dfki.s2m2.filter.Average#getOperands <em>Operands</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.dfki.s2m2.filter.FilterPackage#getAverage()
 * @model
 * @generated
 */
public interface Average<Domain> extends NumericalExpression<Domain> {
	/**
	 ...
	 * @see de.dfki.s2m2.filter.FilterPackage#getAverage_Operands()
