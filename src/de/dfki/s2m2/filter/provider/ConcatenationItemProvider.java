...
/**
 * This is the item provider adapter for a {@link de.dfki.s2m2.filter.Concatenation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConcatenationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FilterPackage.Literals.CONCATENATION__OPERAND);
		}
	...
	public String getText(Object object) {
		String label = ((Concatenation<?>)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Concatenation_type") :
			getString("_UI_Concatenation_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Concatenation.class)) {
