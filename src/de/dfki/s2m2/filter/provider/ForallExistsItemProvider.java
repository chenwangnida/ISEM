...
/**
 * This is the item provider adapter for a {@link de.dfki.s2m2.filter.ForallExists} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ForallExistsItemProvider
	 ...
	 * @generated
	 */
	public ForallExistsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FilterPackage.Literals.FORALL_EXISTS__OPERAND);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ForallExists"));
	}
	...
	public String getText(Object object) {
		String label = ((ForallExists<?>)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ForallExists_type") :
			getString("_UI_ForallExists_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ForallExists.class)) {
			case FilterPackage.FORALL_EXISTS__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case FilterPackage.FORALL_EXISTS__OPERAND:
