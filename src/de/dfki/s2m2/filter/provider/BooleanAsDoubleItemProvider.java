...
/**
 * This is the item provider adapter for a {@link de.dfki.s2m2.filter.BooleanAsDouble} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanAsDoubleItemProvider
	 ...
	 * @generated
	 */
	public BooleanAsDoubleItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FilterPackage.Literals.BOOLEAN_AS_DOUBLE__OPERAND);
		}
	...
	/**
	 * This returns BooleanAsDouble.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BooleanAsDouble"));
	}
	...
	public String getText(Object object) {
		String label = ((BooleanAsDouble<?>)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_BooleanAsDouble_type") :
			getString("_UI_BooleanAsDouble_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BooleanAsDouble.class)) {
			case FilterPackage.BOOLEAN_AS_DOUBLE__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case FilterPackage.BOOLEAN_AS_DOUBLE__OPERAND:
