...
/**
 * This is the item provider adapter for a {@link de.dfki.s2m2.filter.FixedValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FixedValueItemProvider
	...
	protected void addAlphaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FixedValue_alpha_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FixedValue_alpha_feature", "_UI_FixedValue_type"),
				 FilterPackage.Literals.FIXED_VALUE__ALPHA,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_FixedValue_type") + " (" + ((FixedValue<?>)object).getAlpha() + ")" :
			getString("_UI_FixedValue_type") + " (" + ((FixedValue<?>)object).getAlpha() + ")" + " " + label;
	}
