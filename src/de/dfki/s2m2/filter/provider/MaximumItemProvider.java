...
/**
 * This is the item provider adapter for a {@link de.dfki.s2m2.filter.Maximum} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MaximumItemProvider
	 ...
	 * @generated
	 */
	public MaximumItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FilterPackage.Literals.MAXIMUM__OPERANDS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Maximum"));
	}
	...
	public String getText(Object object) {
		String label = ((Maximum<?>)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Maximum_type") :
			getString("_UI_Maximum_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Maximum.class)) {
