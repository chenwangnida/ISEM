...
/**
 * This is the item provider adapter for a {@link de.dfki.s2m2.filter.GreaterEquals} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GreaterEqualsItemProvider
	 ...
	 * @generated
	 */
	public GreaterEqualsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FilterPackage.Literals.GREATER_EQUALS__LEFT_OPERAND);
			childrenFeatures.add(FilterPackage.Literals.GREATER_EQUALS__RIGHT_OPERAND);
		}
	...
	/**
	 * This returns GreaterEquals.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GreaterEquals"));
	}
	...
	public String getText(Object object) {
		String label = ((GreaterEquals<?>)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GreaterEquals_type") :
			getString("_UI_GreaterEquals_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GreaterEquals.class)) {
			case FilterPackage.GREATER_EQUALS__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case FilterPackage.GREATER_EQUALS__LEFT_OPERAND:
			case FilterPackage.GREATER_EQUALS__RIGHT_OPERAND:
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == FilterPackage.Literals.GREATER_EQUALS__LEFT_OPERAND ||
			childFeature == FilterPackage.Literals.GREATER_EQUALS__RIGHT_OPERAND;
