 ...
 * <ul>
 *   <li>{@link de.dfki.s2m2.filter.And#getOperands <em>Operands</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.dfki.s2m2.filter.FilterPackage#getAnd()
 * @model
 * @generated
 */
public interface And<Domain> extends BooleanExpression<Domain> {
	/**
	 ...
	 * @see de.dfki.s2m2.filter.FilterPackage#getAnd_Operands()
