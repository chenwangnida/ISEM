 ...
 * @generated
 */
public class LuceneAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected LuceneSwitch<Adapter> modelSwitch =
		new LuceneSwitch<Adapter>() {
			@Override
			public Adapter caseLuceneMemoryIndex(LuceneMemoryIndex object) {
				return createLuceneMemoryIndexAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.s2m2.filter.textsim.lucene.LuceneMemoryIndex <em>Memory Index</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createLuceneMemoryIndexAdapter() {
		return null;
	}
